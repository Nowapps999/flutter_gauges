...
class GaugeRange {
  ...
  GaugeRange(
      ...
      : startWidth = startWidth == null
            ? label != null
                ? startWidth
                : 10
            : startWidth,
        endWidth = endWidth == null
            ? label != null
                ? endWidth
                : 10
            : endWidth,
  ...
  void _calculateRangePosition() {
    ...
    _actualStartValue = _minMax(startValue, _axis.minimum, _axis.maximum);
    _actualEndValue = _minMax(endValue, _axis.minimum, _axis.maximum);
