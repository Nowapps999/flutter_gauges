  ...
  void paint(Canvas canvas, Size size) {
    if (_axis.backgroundImage != null &&
      ...
      paintImage(
        canvas: canvas,
        rect: _rect,
        scale: _axis._backgroundImageInfo!.scale,
  ...
  List<double>? _getGradientOffset() {
    if (_axis.axisLineStyle.gradient!.stops != null &&
      ...
      final double _difference =
          1 / _axis.axisLineStyle.gradient!.colors.length;
      final List<double>? _offsets = List<double>.filled(
          _axis.axisLineStyle.gradient!.colors.length, 0,
          growable: false);
  ...
  void _drawMajorTicks(Canvas canvas) {
    ...
    if (_axis._actualMajorTickLength! > 0 &&
      ...
      for (num i = 0; i < _length; i++) {
        final _TickOffset _tickOffset = _axis._majorTickOffsets![i as int];
        ...
        final TextSpan span = TextSpan(
            ...
            style: TextStyle(
                color: _axis.ranges != null &&
                    ...
                    ? _axis._getRangeColor(label.value as double?) ??
                        _labelColor
                    : _labelColor,
